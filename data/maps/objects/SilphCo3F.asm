SilphCo3F_Object:
	...
	def_object_events
	object_event 24,  8, SPRITE_SATOSHI, STAY, NONE, 1 ; person
	object_event 20,  7, SPRITE_EVIL_GRUNT_M, STAY, LEFT, 2, OPP_EVIL_GRUNT, 24
	object_event  7,  9, SPRITE_SCIENTIST_M, STAY, DOWN, 3, OPP_SCIENTIST, 4
