Route11_Object:
	...
	object_event 13,  5, SPRITE_YOUNGSTER1, STAY, LEFT, 3, OPP_YOUNGSTER, 9
	object_event 36, 11, SPRITE_ENGINEER, STAY, DOWN, 4, OPP_ENGINEER, 1
	object_event 22,  4, SPRITE_YOUNGSTER1, STAY, UP, 5, OPP_YOUNGSTER, 10
	object_event 45,  7, SPRITE_GAMBLER, STAY, DOWN, 6, OPP_GAMBLER, 3
	object_event 33,  3, SPRITE_GAMBLER, STAY, UP, 7, OPP_GAMBLER, 4
	object_event 43,  5, SPRITE_YOUNGSTER1, STAY, RIGHT, 8, OPP_YOUNGSTER, 11
	object_event 45, 16, SPRITE_ENGINEER, STAY, LEFT, 9, OPP_ENGINEER, 2
	object_event 22, 12, SPRITE_YOUNGSTER1, STAY, UP, 10, OPP_YOUNGSTER, 12
