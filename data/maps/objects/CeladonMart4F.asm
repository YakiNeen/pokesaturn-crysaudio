CeladonMart4F_Object:
	...
	def_object_events
	object_event  5,  7, SPRITE_BARMAN1, STAY, NONE, 1 ; person
	object_event 15,  5, SPRITE_SUPER_NERD2, WALK, LEFT_RIGHT, 2 ; person
	object_event  5,  2, SPRITE_YOUNGSTER1, WALK, LEFT_RIGHT, 3 ; person
