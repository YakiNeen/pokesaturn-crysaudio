CeladonMart3F_Object:
	...
	def_object_events
	object_event 16,  5, SPRITE_BARMAN1, STAY, NONE, 1 ; person
	object_event 11,  6, SPRITE_GAME_BOY_F, STAY, DOWN, 2 ; person
	object_event  7,  2, SPRITE_GAME_BOY_M, STAY, RIGHT, 3 ; person
	object_event  8,  2, SPRITE_GAME_BOY_F, STAY, LEFT, 4 ; person
