Route12_Object:
	...
	object_event 14, 31, SPRITE_FISHER, STAY, LEFT, 2, OPP_FISHERMAN, 3
	object_event  5, 39, SPRITE_FISHER, STAY, UP, 3, OPP_FISHERMAN, 4
	object_event 11, 92, SPRITE_JR_TRAINER_M, STAY, LEFT, 4, OPP_JR_TRAINER_M, 9
	object_event 14, 76, SPRITE_ROCKER, STAY, UP, 5, OPP_ROCKER, 2
	object_event 12, 40, SPRITE_FISHER, STAY, LEFT, 6, OPP_FISHERMAN, 5
	object_event  9, 52, SPRITE_FISHER, STAY, RIGHT, 7, OPP_FISHERMAN, 6
	object_event  6, 87, SPRITE_FISHER, STAY, DOWN, 8, OPP_FISHERMAN, 11
