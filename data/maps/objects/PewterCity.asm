PewterCity_Object:
	...
	def_object_events
	object_event  8, 15, SPRITE_LASS, STAY, NONE, 1 ; person
	object_event 17, 25, SPRITE_HIKER, STAY, NONE, 2 ; person
	object_event 27, 17, SPRITE_BUG_CATCHER_M, STAY, NONE, 3 ; person
	object_event 26, 25, SPRITE_JR_TRAINER_M, WALK, LEFT_RIGHT, 4 ; person
	object_event 35, 16, SPRITE_YOUNGSTER1, STAY, DOWN, 5 ; person
