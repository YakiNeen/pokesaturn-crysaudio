OaksLab_Object:
	...
	def_object_events
	object_event  4,  3, SPRITE_AB, STAY, NONE, 1, OPP_RIVAL1, 1
	...
	object_event  5,  2, SPRITE_BA, STAY, DOWN, 5 ; person
	object_event  2,  1, SPRITE_POKEDEX, STAY, NONE, 6 ; person
	object_event  3,  1, SPRITE_POKEDEX, STAY, NONE, 7 ; person
	object_event  5, 10, SPRITE_BA, STAY, UP, 8 ; person
	object_event  1,  9, SPRITE_SCIENTIST_F, WALK, UP_DOWN, 9 ; person
	object_event  2, 10, SPRITE_SCIENTIST_M, STAY, NONE, 10 ; person
	object_event  8, 10, SPRITE_SCIENTIST_F, STAY, NONE, 11 ; person
