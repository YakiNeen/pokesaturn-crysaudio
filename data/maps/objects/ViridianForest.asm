ViridianForest_Object:
	...
	def_object_events
	object_event 16, 43, SPRITE_BUG_CATCHER_F, STAY, NONE, 1 ; person
	object_event 30, 33, SPRITE_BUG_CATCHER_M, STAY, LEFT, 2, OPP_BUG_CATCHER, 1
	object_event 30, 19, SPRITE_BUG_CATCHER_M, STAY, LEFT, 3, OPP_BUG_CATCHER, 2
	object_event  2, 18, SPRITE_BUG_CATCHER_M, STAY, LEFT, 4, OPP_BUG_CATCHER, 3
	...
	object_event 27, 40, SPRITE_YOUNGSTER1, STAY, NONE, 8 ; person
