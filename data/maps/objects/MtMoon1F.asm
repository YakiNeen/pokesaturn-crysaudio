MtMoon1F_Object:
	...
	object_event 12, 16, SPRITE_YOUNGSTER1, STAY, RIGHT, 2, OPP_YOUNGSTER, 3
	object_event 30,  4, SPRITE_LASS, STAY, DOWN, 3, OPP_LASS, 5
	object_event 24, 31, SPRITE_SUPER_NERD3, STAY, UP, 4, OPP_SUPER_NERD, 1
	object_event 16, 23, SPRITE_LASS, STAY, DOWN, 5, OPP_LASS, 6
	object_event  7, 22, SPRITE_BUG_CATCHER_M, STAY, DOWN, 6, OPP_BUG_CATCHER, 7
	object_event 30, 27, SPRITE_BUG_CATCHER_M, STAY, RIGHT, 7, OPP_BUG_CATCHER, 8
