CeladonMansion3F_Object:
	...
	def_object_events
	object_event  0,  4, SPRITE_BARMAN2, STAY, UP, 1 ; person
	object_event  3,  4, SPRITE_BARMAN1, STAY, UP, 2 ; person
	object_event  0,  7, SPRITE_SUPER_NERD1, STAY, UP, 3 ; person
	object_event  2,  3, SPRITE_SATOSHI, STAY, NONE, 4 ; person
