MtMoonPokecenter_Object:
	...
	object_event  4,  3, SPRITE_YOUNGSTER1, STAY, UP, 2 ; person
	object_event  7,  3, SPRITE_GENTLEMAN, STAY, UP, 3 ; person
	object_event 10,  6, SPRITE_MIDDLE_AGED_MAN, WALK, LEFT_RIGHT, 4 ; person
	object_event  7,  2, SPRITE_BOOK, STAY, NONE, 5 ; person
	object_event 11,  2, SPRITE_RECEPTIONIST, STAY, DOWN, 6 ; person
