SaffronGym_Object:
	...
	def_object_events
	object_event  9,  8, SPRITE_GYM_LEADER6, STAY, DOWN, 1, OPP_GYM_LEADER6, 1
	object_event 10,  1, SPRITE_CHANNELER, STAY, DOWN, 2, OPP_CHANNELER, 14
	object_event 17,  1, SPRITE_PSYCHIC_M, STAY, DOWN, 3, OPP_PSYCHIC_TR, 1
	object_event  3,  7, SPRITE_CHANNELER, STAY, DOWN, 4, OPP_CHANNELER, 15
	object_event 17,  7, SPRITE_PSYCHIC_M, STAY, DOWN, 5, OPP_PSYCHIC_TR, 2
	object_event  3, 13, SPRITE_CHANNELER, STAY, DOWN, 6, OPP_CHANNELER, 16
	object_event 17, 13, SPRITE_PSYCHIC_M, STAY, DOWN, 7, OPP_PSYCHIC_TR, 3
	object_event  3,  1, SPRITE_PSYCHIC_M, STAY, DOWN, 8, OPP_PSYCHIC_TR, 4
	object_event 10, 15, SPRITE_DANPEI, STAY, DOWN, 9 ; person
