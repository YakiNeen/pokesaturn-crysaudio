RocketHideoutB4F_Object:
	...
	def_object_events
	object_event 25,  3, SPRITE_EVIL_BOSS, STAY, DOWN, 1, OPP_EVIL_BOSS, 1
	object_event 23, 12, SPRITE_EVIL_GRUNT_M, STAY, DOWN, 2, OPP_EVIL_GRUNT, 16
	object_event 26, 12, SPRITE_EVIL_GRUNT_M, STAY, DOWN, 3, OPP_EVIL_GRUNT, 17
	object_event 11,  2, SPRITE_EVIL_GRUNT_M, STAY, DOWN, 4, OPP_EVIL_GRUNT, 18
