VermilionGym_Object:
	...
	def_object_events
	object_event  5,  1, SPRITE_GYM_LEADER3, STAY, DOWN, 1, OPP_GYM_LEADER3, 1
	object_event  9,  6, SPRITE_LITTLE_GIRL, STAY, LEFT, 2, OPP_LITTLE_GIRL, 1
	object_event  3,  8, SPRITE_ROCKER, STAY, LEFT, 3, OPP_ROCKER, 1
	object_event  0, 10, SPRITE_SAILOR, STAY, RIGHT, 4, OPP_SAILOR, 8
	object_event  4, 14, SPRITE_DANPEI, STAY, DOWN, 5 ; person
