RockTunnel1F_Object:
	...
	object_event 23,  8, SPRITE_POKEMANIAC_M, STAY, LEFT, 4, OPP_POKEMANIAC, 7
	object_event 37, 21, SPRITE_JR_TRAINER_F, STAY, LEFT, 5, OPP_JR_TRAINER_F, 15
	object_event 22, 24, SPRITE_JR_TRAINER_F, STAY, DOWN, 6, OPP_JR_TRAINER_F, 16
	object_event 32, 24, SPRITE_JR_TRAINER_F, STAY, RIGHT, 7, OPP_JR_TRAINER_F, 17
