SSAnne2FRooms_Object:
	...
	object_event 13,  4, SPRITE_FISHER, STAY, LEFT, 2, OPP_FISHERMAN, 1
	object_event  0, 14, SPRITE_GENTLEMAN, STAY, RIGHT, 3, OPP_GENTLEMAN, 4
	object_event  2, 11, SPRITE_LASS, STAY, DOWN, 4, OPP_LASS, 12
