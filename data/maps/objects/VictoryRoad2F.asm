VictoryRoad2F_Object:
	...
	def_object_events
	object_event 12,  9, SPRITE_BLACKBELT_M, STAY, LEFT, 1, OPP_BLACKBELT, 9
	object_event 21, 13, SPRITE_JUGGLER, STAY, LEFT, 2, OPP_JUGGLER, 2
	object_event 19,  8, SPRITE_TAMER, STAY, DOWN, 3, OPP_TAMER, 5
	object_event  4,  2, SPRITE_POKEMANIAC_M, STAY, DOWN, 4, OPP_POKEMANIAC, 6
	object_event 26,  3, SPRITE_JUGGLER, STAY, LEFT, 5, OPP_JUGGLER, 5
	object_event 11,  5, SPRITE_MOLTRES, STAY, UP, 6, MOLTRES, 50 | OW_POKEMON
