RockTunnelB1F_Object:
	...
	def_object_events
	object_event 11, 13, SPRITE_JR_TRAINER_F, STAY, DOWN, 1, OPP_JR_TRAINER_F, 8
	object_event  6, 10, SPRITE_HIKER, STAY, DOWN, 2, OPP_HIKER, 9
	object_event  3,  5, SPRITE_POKEMANIAC_M, STAY, DOWN, 3, OPP_POKEMANIAC, 3
	object_event 20, 21, SPRITE_POKEMANIAC_M, STAY, RIGHT, 4, OPP_POKEMANIAC, 4
	object_event 30, 10, SPRITE_HIKER, STAY, DOWN, 5, OPP_HIKER, 10
	object_event 14, 28, SPRITE_JR_TRAINER_F, STAY, RIGHT, 6, OPP_JR_TRAINER_F, 9
	object_event 33,  5, SPRITE_HIKER, STAY, RIGHT, 7, OPP_HIKER, 11
	object_event 26, 30, SPRITE_POKEMANIAC_M, STAY, DOWN, 8, OPP_POKEMANIAC, 5
