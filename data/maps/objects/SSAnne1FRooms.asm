SSAnne1FRooms_Object:
	...
	object_event 11, 14, SPRITE_YOUNGSTER1, STAY, UP, 3, OPP_YOUNGSTER, 8
	object_event 13, 11, SPRITE_LASS, STAY, LEFT, 4, OPP_LASS, 11
	object_event 22,  3, SPRITE_BLACKBELT_F, WALK, UP_DOWN, 5 ; person
	object_event  0, 14, SPRITE_MIDDLE_AGED_MAN, STAY, NONE, 6 ; person
	object_event  2, 11, SPRITE_BUG_CATCHER_F, STAY, DOWN, 7 ; person
	object_event  3, 11, SPRITE_WIGGLYTUFF, STAY, DOWN, 8 ; person
	object_event 10, 13, SPRITE_BIRD_KEEPER_F, STAY, RIGHT, 9 ; person
