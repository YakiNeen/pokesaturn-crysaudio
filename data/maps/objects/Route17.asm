Route17_Object:
	...
	def_object_events
	object_event 12, 19, SPRITE_CUE_BALL, STAY, LEFT, 1, OPP_CUE_BALL, 4
	object_event 11, 16, SPRITE_CUE_BALL, STAY, RIGHT, 2, OPP_CUE_BALL, 5
	...
	object_event 17, 58, SPRITE_CUE_BALL, STAY, LEFT, 6, OPP_CUE_BALL, 6
	object_event  2, 68, SPRITE_CUE_BALL, STAY, RIGHT, 7, OPP_CUE_BALL, 7
	object_event 14, 98, SPRITE_CUE_BALL, STAY, RIGHT, 8, OPP_CUE_BALL, 8
