...
IF DEF(_SATURN)
	INCBIN "gfx/pokemon/front_saturn_1st_generation/150.pic", 0, 1 ; sprite dimensions
ENDC
IF DEF(_MARS)
	INCBIN "gfx/pokemon/front_mars_1st_generation/150.pic", 0, 1 ; sprite dimensions
ENDC
