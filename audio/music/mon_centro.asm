...
Music_Pokecenter_Dois::
	...
	note F#, 2
	note G_, 2
	sound_loop 0, Music_Pokecenter_Dois


Music_Pokecenter_Ch2::
	vibrato 8, 2, 5

Music_Pokecenter_Principal::
	...
	note E_, 2
	note D_, 8
	sound_loop 0, Music_Pokecenter_Principal
...
Music_Pokecenter_Baixo::
	...
	note F#, 2
	note E_, 2
	sound_loop 0, Music_Pokecenter_Baixo
