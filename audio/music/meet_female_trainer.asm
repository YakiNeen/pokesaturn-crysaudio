...
Music_MeetFemaleTrainer_Dois::
	octave 3
	note E_, 4
	sound_loop 12, Music_MeetFemaleTrainer_Dois
	note E_, 4
	octave 2
	note B_, 4
	note B_, 4
	octave 3
	note E_, 4
	sound_loop 0, Music_MeetFemaleTrainer_Dois
...
Music_MeetFemaleTrainer_Principal::
	note_type 12, 12, 2
	octave 3
	note B_, 4
	octave 4
	...
	note G#, 2
	note A_, 2
	sound_loop 0, Music_MeetFemaleTrainer_Principal
...
Music_MeetFemaleTrainer_Baixo::
	...
	note B_, 1
	rest 3
	sound_loop 0, Music_MeetFemaleTrainer_Baixo
