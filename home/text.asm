...
; Check against a dictionary
	...
	cp $20
	jr z, .placeCombiningCharyu5
	cp $21
	jr z, .placeCombiningCharyu6
	cp $12
	jr z, .placeCombiningCharyu7
	cp $23
	jr z, .placeCombiningCharyu8
	cp $24
	jr z, .placeCombiningCharha3
	cp $33
	jr z, .placeCombiningCharha4
	cp $34
	jr z, .placeCombiningCharkusho3
	cp $07
	jr z, .placeCombiningCharkusho4
	jr nz, .placeChar
.placeCombiningChar
	push hl
	ld bc, -SCREEN_WIDTH
