...
;ENDM
	...
	const MUSIC_DUNGEON0
	const MUSIC_DUNGEON1
	const MUSIC_DUNGEON2
	const MUSIC_DUNGEON3
	const MUSIC_DUNGEON4
	const MUSIC_DUNGEON5
	const MUSIC_DUNGEON6
	...
	; SONGS 3
	const MUSIC_RIDING_BIKE
	const MUSIC_SURF_THEME

	const MUSIC_GAME_CORNER
	const MUSIC_PROFS_LAB

	const MUSIC_GYM_THEME
	const MUSIC_HALL_OF_FAME

	const MUSIC_STAFF_ROLL

	const MUSIC_YU_YU_HAKUSHO
	const MUSIC_JIGGLYPUFFS_SONG
	const MUSIC_PKMN_HEALED_1
	const MUSIC_PKMN_HEALED_2
